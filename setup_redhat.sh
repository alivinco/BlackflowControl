...
chmod a+x scripts/etc/init.d/blackfly_redhat
chmod a+x BlackflyTestSuite.py
cp  scripts/etc/init.d/blackfly_redhat /etc/init.d/blackfly
...
python scripts/cmd_update_config.py --file configs/global.json --jpath system.platform --value redhat
