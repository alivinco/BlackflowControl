...
def init_app_components():
    ...
    root_uri = msg_man.global_configs["system"]["root_uri"] if "root_uri" in msg_man.global_configs["system"] else "/blackfly"
    ...
    mqtt.set_mqtt_params(msg_man.global_configs["mqtt"]["client_id"], msg_man.global_configs["mqtt"]["username"], msg_man.global_configs["mqtt"]["password"],
                         msg_man.global_configs["mqtt"]["global_topic_prefix"], msg_man.global_configs["mqtt"]["enable_sys"])
...
def init_controllers():
    ...
    @app.route(root_uri + '/ui/inter_console')
    @login_required
    ...
    @app.route(root_uri + '/ui/dashboard/<dash_name>')
    @login_required
    def dashboard_ui(dash_name):
        ...
        try:
            ...
            log.exception(ex)
        return render_template('dashboard.html', dashboard_id=dash_name, mapping=ext_mapping, address_list=address_list, groups=groups, cache=cache,
                               global_context=global_context)

    @app.route(root_uri + '/ui/mqtt_broker_monitor')
    @login_required
    ...
    @app.route(root_uri + '/ui/address_mapping')
    @login_required
    ...
    @app.route(root_uri + '/ui/device_templates')
    @login_required
    ...
    @app.route(root_uri + '/ui/address_map/<id>')
    @login_required
    ...
    @app.route(root_uri + '/ui/msg_class_mapping')
    @login_required
    ...
    @app.route(root_uri + '/ui/timeseries/chart/<dev_id>')
    @login_required
    ...
    @app.route(root_uri + '/ui/timeseries/table/<dev_id>/<start_time>/<end_time>', methods=["POST", "GET"])
    @login_required
    ...
    @app.route(root_uri + '/ui/timeseries/timeline/<start_time>/<end_time>', methods=["POST", "GET"])
    @login_required
    ...
    @app.route(root_uri + '/ui/msg_types_for_approval')
    @login_required
    ...
    def settings_ui():
        if request.method == 'POST':
            ...
            mqtt.set_mqtt_params(request.form["mqtt_client_id"], request.form["mqtt_username"], request.form["mqtt_password"], request.form["mqtt_global_topic_prefix"],
                                 msg_man.global_configs["mqtt"]["enable_sys"])
    ...
    @app.route(root_uri + '/api/send_command', methods=["POST"])
    @login_required
    def send_command():
    ...
    @app.route(root_uri + '/api/get_msg_from_cache/<key>')
    ...
    @app.route(root_uri + '/api/approve_msg_class', methods=["POST"])
    @login_required
    ...
    @app.route(root_uri + '/api/address_manager', methods=["POST", "PUT"])
    @login_required
    def address_manager():
        ...
        try:
            ...
            if request.method == "PUT":
                ...
                if action == "update_address_mapping":
                    ...
                    msg_man.update_address_mapping(id, request.form["name"], msg_class, msg_type, request.form["address"], override_props, override_value_path,
                                                   record_history, transport=transport)
    ...
    @app.route(root_uri + '/api/filters', methods=["POST", "GET"])
    @login_required
    def filters_api():
    ...
    @app.route(root_uri + '/api/dashboard', methods=["POST", "GET"])
    @login_required
    def dashboard_api():
    ...
    @app.route(root_uri + '/api/msg_history', methods=["POST"])
    @login_required
    def msg_history_api():
    ...
    @app.route(root_uri + '/api/get_last_raw_msg/<key>')
    @login_required
    ...
    @app.route(root_uri + '/api/timeseries/timeline')
    @login_required
    def get_timeline():
    ...
    @app.route(root_uri + '/ui/zw_diagnostics')
    @login_required
    def zw_diagnostics():
        ...
        if action == "refresh_routing_info" or not response:
            ...
            response = sync_async_client.send_sync_msg(zwapi.get_routing_info(), "/ta/zw/commands", "/ta/zw/events", correlation_type="MSG_TYPE",
                                                       correlation_msg_type="zw_ta.routing_info", timeout=30)
        ...
        context = sync_async_client.send_sync_msg(zwapi.get_context(), "/ta/zw/commands", "/ta/zw/events", correlation_type="MSG_TYPE",
                                                  correlation_msg_type="zw_ta.context", timeout=5)
    ...
    @app.route(root_uri + '/api/zw_manager', methods=["POST"])
    @login_required
    def zw_manager_api():
        action = request.form["action"]
        ...
        if action == "zw_inclusion_mode":
            ...
            if start:
                response = sync_async_client.send_sync_msg(msg, "/ta/zw/commands", "/ta/zw/events", timeout=60, correlation_type="MSG_TYPE",
                                                           correlation_msg_type="zw_ta.inclusion_report")
            else:
            ...
            if start:
                response = sync_async_client.send_sync_msg(msg, "/ta/zw/commands", "/ta/zw/events", timeout=60, correlation_type="MSG_TYPE",
                                                           correlation_msg_type="zw_ta.exclusion_report")
            else:
                mqtt.publish("/ta/zw/commands", json.dumps(msg), 1)
                response = {}
            ...
            response = sync_async_client.send_sync_msg(msg, "/ta/zw/commands", "/ta/zw/events", timeout=30, correlation_type="MSG_TYPE",
                                                       correlation_msg_type="net.ping_report")
            jobj = json.dumps(response)
            ...
            response = sync_async_client.send_sync_msg(msg, "/ta/zw/commands", "/ta/zw/events", timeout=30, correlation_type="MSG_TYPE",
                                                       correlation_msg_type="zw_ta.learn_mode")
            ...
            response = sync_async_client.send_sync_msg(msg, "/ta/zw/commands", "/ta/zw/events", timeout=30, correlation_type="MSG_TYPE",
                                                       correlation_msg_type="zw_ta.controller_full_info")
            jobj = json.dumps(response)
    ...
    @app.route(root_uri + '/ui/msg_history', methods=["GET", "POST"])
    @login_required
    def msg_history():
    ...
    @app.route(root_uri + '/api/get_msg_history', methods=["GET", "POST"])
    @login_required
    ...
    @app.route(root_uri + '/api/get_server_info', methods=["GET", "POST"])
    @login_required
    ...
    @app.route(root_uri + '/ui/alerts', methods=["GET", "POST"])
    @login_required
    def alerts():
        log.info("Msg history")
    ...
    @app.route(root_uri + '/ui/work_session', methods=["POST", "GET"])
    @login_required
    def work_session():
        status = ""
...
if __name__ == '__main__':
    ...
    # root_uri = "/bla"
    # TODO: make configurable BF_INSTANCE_NAME , BF_GW_ID , BF_USERS_PATH and configurble user.json location
    init_app_components()
    init_controllers()
